<template>
  <div class="prose prose-slate max-w-none">
    ...
    <p>
      Since we do not deploy non-essential cookies, no cookie consent banner
      is necessary under GDPR, CCPA, or similar regulations. If this changes
      in the future, we will update this notice and provide a consent mechanism.
    </p>
