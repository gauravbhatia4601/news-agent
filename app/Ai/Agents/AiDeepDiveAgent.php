...
#[MaxTokens(32768)]
#[Temperature(0.6)]
class AiDeepDiveAgent implements Agent, HasStructuredOutput
{
    use Promptable;
...
PROMPT;
    ...
    {
        return [
            'title' => $schema->string()->required()->description('Engaging headline with primary keyword, 50-80 characters, include a number or year'),
            'article' => $schema->string()->required()->description('Full markdown article with ## sections. 1200-2000 words. Must include: Key Developments, The Big Picture, Technical Deep Dive, Industry & Market Impact, Regional Perspectives, What to Watch, FAQ.'),
